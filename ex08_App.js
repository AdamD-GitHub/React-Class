  ...
  render() {
    return (
      <Grid container spacing={2}>
        ...
        <Grid item>
          <ExerciseHeader1 number={exercise.number} title={exercise.title}></ExerciseHeader1>
          <ExerciseHeader2 number={exercise.number} title={exercise.title}></ExerciseHeader2>
